/*
We have aoe_turf (Located in aoe_turf.dm) Which is just a burst around the user.
Targeted which requires a mob in range
and Projectiles which just launch projectiles.
This one just performs the effects around the we click.
*/
