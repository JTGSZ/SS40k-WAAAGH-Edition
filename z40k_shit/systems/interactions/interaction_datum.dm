...
/datum/interaction/proc/do_interaction(var/mob/living/user, var/mob/living/target)
	if(physical_contact_check(user,target))

/datum/interaction/proc/physical_contact_check(var/mob/living/user, var/mob/living/target)
