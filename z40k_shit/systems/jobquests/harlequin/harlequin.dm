...
/datum/job_quest/harlequin/main_body()
	switch(alignment)
		...
		if(-25)
			...
			alignment--
		if(-26)
			to_chat(our_protagonist, "<span class='notice'>You don't remember how this got in your pocket... It might be the work of the laughing god. You have a feeling it will help you get the armor you need. Perhaps we should start with that black vending machine in our room.</span>")
