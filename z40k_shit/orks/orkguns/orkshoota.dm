/obj/item/weapon/gun/projectile/automatic/complexweapon/shoota
...
/obj/item/weapon/gun/projectile/automatic/complexweapon/shoota/update_icon()
...
/obj/item/weapon/gun/projectile/automatic/complexweapon/shoota/Fire(atom/target as mob|obj|turf|area, mob/living/user as mob|obj, params, reflex = 0, struggle = 0)
	..()
	if(!isork(user))
