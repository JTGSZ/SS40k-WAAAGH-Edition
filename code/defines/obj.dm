...
/datum/controller/occupations/proc/predict_manifest()
	crystal_ball = list("AI" = 0, "Cyborg" = 0, "General" = 0, "Head of Personnel" = 0, "Head of Security" = 0, "Chief Engineer" = 0, "Chief Medical Officer" = 0, "Research Director" = 0)
