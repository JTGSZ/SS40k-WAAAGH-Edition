...
/datum/dynamic_ruleset/latejoin/infiltrator
	...
	protected_from_jobs = list("Security Officer", "Warden", "Head of Personnel", "Detective", "Head of Security", "General", "Merchant")
...
/datum/dynamic_ruleset/latejoin/provocateur
	...
	enemy_jobs = list("AI", "Cyborg", "Security Officer","Detective","Head of Security", "General", "Warden")
	required_enemies = list(2,2,1,1,1,1,1,0,0,0)
	required_candidates = 1
	weight = 2
	cost = 20
