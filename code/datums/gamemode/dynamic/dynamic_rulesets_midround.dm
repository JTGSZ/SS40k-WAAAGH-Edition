...
/datum/dynamic_ruleset/midround/autotraitor
	...
	protected_from_jobs = list("Security Officer", "Warden", "Detective", "Head of Security", "General", "Head of Personnel", "Cyborg", "Merchant")
...
/datum/dynamic_ruleset/midround/from_ghosts/faction_based/blob_storm
	...
	enemy_jobs = list("AI", "Cyborg", "Security Officer", "Station Engineer","Chief Engineer", "Roboticist","Head of Security", "General")
