...
/datum/dynamic_ruleset/roundstart/traitor
	...
	protected_from_jobs = list("Trooper", "Merchant", "Sergeant", "Head of Personnel", "Cyborg", "Inquisitor", "Commissar", "General")
...
/datum/dynamic_ruleset/roundstart/malf
	...
	restricted_from_jobs = list("Trooper", "Sergeant","Inquisitor","Commissar", "General", "Research Director", "Chief Engineer")
...
/datum/dynamic_ruleset/roundstart/blob
	...
	restricted_from_jobs = list("AI", "Cyborg", "Mobile MMI", "Trooper", "Sergeant","Inquisitor","Commissar", "General", "Head of Personnel")
	enemy_jobs = list("AI", "Cyborg", "Trooper", "Sergeant","Inquisitor","Commissar", "General")
	required_enemies = list(3,3,3,3,3,2,1,1,0,0)
	required_candidates = 1
	weight = 3
...
/datum/dynamic_ruleset/roundstart/delayed/revs
	...
	restricted_from_jobs = list("Merchant","AI", "Cyborg", "Mobile MMI", "Trooper", "Sergeant", "Inquisitor", "Commissar", "General", "Head of Personnel", "Chief Engineer", "Chief Medical Officer", "Research Director", "Internal Affairs Agent")
	enemy_jobs = list("Trooper","Inquisitor","Commissar", "General", "Sergeant")
