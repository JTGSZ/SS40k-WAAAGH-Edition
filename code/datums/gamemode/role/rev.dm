/datum/role/revolutionary
	...
	id = REV
	required_pref = REV
	restricted_jobs = list("Trooper", "Warden", "Inquisitor", "AI", "Cyborg","Mobile MMI","General", "Head of Personnel", "Commissar", "Chief Engineer", "Research Director", "Chief Medical Officer", "Internal Affairs Agent")
	logo_state = "rev-logo"
