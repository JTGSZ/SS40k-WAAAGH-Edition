/datum/role/legacy_cultist
	...
	disallow_job = FALSE
	restricted_jobs = list("AI", "Cyborg", "Mobile MMI", "Security Officer", "Warden", "Detective", "Head of Security", "General", "Chaplain", "Head of Personnel", "Internal Affairs Agent", "Merchant")
