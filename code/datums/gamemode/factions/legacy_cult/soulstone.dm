...
/obj/item/device/soulstone/attack(var/mob/living/M, mob/user )
...
/obj/item/proc/capture_soul_head(var/target, var/mob/user )//called either when using a soulstone on a head, or on a decapitated body
