...
/datum/preferences/proc/update_preview_icon(var/for_observer=0)		//seriously. This is horrendous.
	...
	if(!for_observer)
		...
		if(job_civilian_high)//I hate how this looks, but there's no reason to go through this switch if it's empty
			...
			switch(job_engsec_high)
				if(GENERAL)
					clothes_s = new /icon(uniform_dmi, "general_s")
					...
					clothes_s.Blend(new /icon(suit_dmi, "commanderarmor"), ICON_OVERLAY)
				...
				if(IGSERGEANT)
					...
					clothes_s.Blend(new /icon(feet_dmi, "imperialboots"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/mob/hands.dmi', "black"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/mob/head.dmi', "guardsmanleader_helmet"), ICON_OVERLAY)
					clothes_s.Blend(new /icon(suit_dmi, "guardsmanleader_armor"), ICON_OVERLAY)
				...
				if(IGTROOPER)
					...
					clothes_s.Blend(new /icon(feet_dmi, "imperialboots"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/mob/hands.dmi', "black"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('icons/mob/head.dmi', "guardsman_helmet"), ICON_OVERLAY)
					clothes_s.Blend(new /icon(suit_dmi, "guardsman_armor"), ICON_OVERLAY)
					clothes_s=blend_backpack(clothes_s,backbag,"impbag","impbag","impbag")
				if(PRIMARISPSYKER)
					clothes_s = new /icon(uniform_dmi, "chapblack_s")
					clothes_s.Blend(new /icon(feet_dmi, "noble-boots"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon(suit_dmi, "psyker_robe"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('icons/mob/head.dmi', "psyker_hat"), ICON_OVERLAY)
				...
				if(ORKNOB)
					clothes_s = new /icon(uniform_dmi, "orkuniform1_s")
					clothes_s.Blend(new /icon('z40k_shit/icons/mob/orks/orkgearMOB.dmi', "orkboots1"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('z40k_shit/icons/mob/orks/orkgearNOBMOB.dmi', "orkuniform1_s"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('z40k_shit/icons/mob/orks/orkgearNOBMOB.dmi', "orkarmor1"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('z40k_shit/icons/mob/orks/orkPREVIEWICONS.dmi', "orkhelmet1"), ICON_OVERLAY)
				if(ORKWARBOSS)
					clothes_s = new/icon('z40k_shit/icons/mob/orks/orkgearWARBOSSMOB.dmi', "warboss_uniform1_s")
					clothes_s.Blend(new /icon('z40k_shit/icons/mob/orks/orkPREVIEWICONS.dmi', "warboss_helmet"), ICON_OVERLAY)
					clothes_s.Blend(new /icon('z40k_shit/icons/mob/orks/orkgearWARBOSSMOB.dmi', "warboss_shoes"), ICON_UNDERLAY)
					clothes_s.Blend(new /icon('z40k_shit/icons/mob/orks/orkgearWARBOSSMOB.dmi', "warboss_armor1"), ICON_UNDERLAY)
