...
/datum/sprite_accessory/hair/bald
	...
	icon_state = "bald"
	gender = MALE
	species_allowed = list("Human","Manifested","Unathi","Grey","Plasmaman","Skellington","Diona","Muton","Golem","Skeletal Vox","Horror","Ghoul","Slime","Mushroom","Evolved Slime","Insectoid", "Ork")
...
/datum/sprite_accessory/facial_hair/shaved
	...
	icon_state = "bald"
	gender = NEUTER
	species_allowed = list("Human","Manifested","Unathi","Tajaran","Skrell","Vox","Grey","Plasmaman","Skellington","Diona","Muton","Golem","Skeletal Vox","Horror","Ghoul","Slime","Mushroom", "Evolved Slime", "Insectoid", "Ork")
