...
/obj/item/weapon/gun/projectile/detective/prefire_check(var/mob/living/carbon/human/M) //to see if the gun fires 357 rounds safely. A non-modified revolver randomly blows up
...
/obj/item/weapon/gun/projectile/detective/verb/rename_gun()
	...
	if(!M.mind)
		return 0
	if(!M.mind.assigned_role == "Inquisitor")
