...
/obj/item/weapon/gun/gatling/afterattack(atom/A , mob/living/user as mob|obj, flag, params, struggle = 0)
	if(flag)
...
/obj/item/weapon/gun/gatling/Fire(atom/target , mob/living/user as mob|obj, params, reflex = 0, struggle = 0)
	..()
