//here is the Ig guns mags and ammo and stuff. 
...
/obj/item/weapon/gun/energy/laser/lasgun //TODO: Make Cell removal and stick-in
	name = "lasgun"
...
/obj/item/weapon/gun/energy/laser/lasgun/attackby(var/obj/item/A as obj, mob/user as mob)
...
/obj/item/weapon/gun/energy/laser/lasgun/attack_self(mob/user as mob)
	if(target)
		return ..()
	if(power_supply)
		RemoveMag(user)
