...
/obj/item/weapon/gun/energy/staff/destruction_wand/Fire(atom/target , mob/living/user as mob|obj, params, reflex = 0, struggle = 0)
	if(power_supply.charge == charge_cost || lifekiller)
...
obj/item/weapon/gun/energy/ricochet/Fire(atom/target , mob/living/user as mob|obj, params, reflex = 0, struggle = 0)
...
/obj/item/weapon/gun/energy/polarstar/afterattack(atom/A , mob/living/user as mob|obj, flag, params, struggle = 0)
	levelChange()
	..()
