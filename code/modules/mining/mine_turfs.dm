...
/turf/unsimulated/mineral/attackby(obj/item/weapon/W , mob/user as mob)
...
/turf/unsimulated/floor/asteroid/attackby(obj/item/weapon/W , mob/user as mob)
...
/turf/simulated/floor/asteroid/attackby(obj/item/weapon/W , mob/user as mob)
	if(!W || !user)
		return 0
	if (istype(W, /obj/item/weapon/pickaxe))
		var/obj/item/weapon/pickaxe/used_digging = W //cast for dig speed and flags
