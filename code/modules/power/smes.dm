...
/obj/machinery/power/battery/smes/attackby(var/obj/item/weapon/W , var/mob/user as mob) //these can only be moved by being reconstructed, solves having to remake the powernet.
