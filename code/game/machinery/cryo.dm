...
/obj/machinery/atmospherics/unary/cryo_cell/MouseDropTo(atom/movable/O , mob/user as mob)
	if(!ismob(O))
		return
...
/obj/machinery/atmospherics/unary/cryo_cell/attackby(var/obj/item/weapon/G , var/mob/user as mob)
