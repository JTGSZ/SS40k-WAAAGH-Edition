...
/obj/machinery/computer/atmoscontrol/attackby(var/obj/item/I , var/mob/user as mob)
...
/obj/machinery/computer/atmoscontrol/emag_act(var/mob/user as mob, var/obj/item/weapon/card/E )
	if(!emagged)
		emagged = 1
		spark(src, 1, FALSE)
