...
/obj/structure/largecrate/lisa/attackby(obj/item/weapon/W , mob/user )	//ugly but oh well
	if(iscrowbar(W))
...
/obj/structure/largecrate/cow/attackby(obj/item/weapon/W , mob/user )
	if(iscrowbar(W))
...
/obj/structure/largecrate/goat/attackby(obj/item/weapon/W , mob/user )
	if(iscrowbar(W))
...
/obj/structure/largecrate/chick/attackby(obj/item/weapon/W , mob/user )
	if(iscrowbar(W))
		var/num = rand(4, 6)
		for(var/i = 0, i < num, i++)
...
/obj/structure/largecrate/hissing/attackby(obj/item/weapon/W , mob/user )
	if(iscrowbar(W))
		var/num = rand(2, 4)
		for(var/i = 1 to num)
...
/obj/structure/largecrate/porcelain/attackby(obj/item/weapon/W , mob/user )
	if(iscrowbar(W))
...
/obj/structure/largecrate/showers/attackby(obj/item/weapon/W , mob/user )
	if(iscrowbar(W))
		for(var/i = 0, i < 2, i++)
...
/obj/structure/largecrate/skele_stand/attackby(obj/item/weapon/W , mob/user )
	if(iscrowbar(W))
...
/obj/structure/largecrate/anomaly_container/attackby(obj/item/weapon/W , mob/user )
	if(iscrowbar(W))
