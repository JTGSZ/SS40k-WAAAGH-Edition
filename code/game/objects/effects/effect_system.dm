...
/datum/effect/effect/system/proc/start() //why is this here? it neither overrides nor does anything else
...
// Goon compat.
/datum/effect/effect/system/smoke_spread/chem/fart/set_up(var/mob/M, n = 5, c = 0, loca, direct)
	if(n > 20)
		n = 20
	number = n
	cardinals = c
