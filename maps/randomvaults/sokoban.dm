...
/datum/map_element/vault/mapruins/sokoban/proc/mark_winner(atom/movable/mover)
...
/datum/map_element/dungeon/sokoban_level/initialize(list/objects)
	...
	for(var/obj/structure/sokoban_teleporter/teleporter in objects)
		...
		teleporter.lazy_register_event(/lazy_event/on_moved, parent, /datum/map_element/vault/mapruins/sokoban/proc/on_cheat)
	...
	if(reward)
		...
		reward.lazy_register_event(/lazy_event/on_moved, parent, /datum/map_element/vault/mapruins/sokoban/proc/mark_winner)
