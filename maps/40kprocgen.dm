...
/datum/map/active
	...
	//Right here we should just enable the IG and ORK Factions
...
//This proc generates rooms from nothing, is it necessarily a good idea?
//This is in comparison to going with a pass with vaults.
